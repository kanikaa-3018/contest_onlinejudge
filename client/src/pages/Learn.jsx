    ...
    <div className="min-h-screen bg-background text-foreground p-6">
      ...
      <div className="space-y-6">
        <div className="bg-card rounded-xl p-6 shadow-lg">
          <h3 className="text-xl font-semibold text-card-foreground mb-4">Striver's SDE Sheet</h3>
        ...
        <div className="bg-card rounded-xl p-6 shadow-lg">
          <h3 className="text-xl font-semibold text-card-foreground mb-4">NeetCode 150</h3>
          <p className="text-muted-foreground mb-4">
        ...
        <div className="bg-card rounded-xl p-6 shadow-lg">
          <h3 className="text-xl font-semibold text-card-foreground mb-4">Love Babbar 450 Sheet</h3>
          <p className="text-muted-foreground mb-4">
        ...
        <div className="bg-card rounded-xl p-6 shadow-lg">
          <h3 className="text-xl font-semibold text-card-foreground mb-4">Fraz 75 Sheet</h3>
          <p className="text-muted-foreground mb-4">
        ...
        <div className="bg-card rounded-xl p-6 shadow-lg">
          <h3 className="text-xl font-semibold text-card-foreground mb-4">Apna College DSA Sheet</h3>
          <p className="text-muted-foreground mb-4">
